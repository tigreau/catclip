...
var helpExampleRegistry = []HelpExample{
	...
	{ID: "include.dist-and-src", Command: "catclip . --include dist --only src dist", Kind: HelpExampleDeterministic, Shell: HelpExampleShellNeutral},
	...
	{ID: "include.env-raw", Command: "catclip .env.example --include .env.example -r", Kind: HelpExampleDeterministic, Shell: HelpExampleShellNeutral},
	...
	{ID: "template.everything-paths", Command: "catclip TARGET --include '*' --with-binaries --paths", Kind: HelpExampleTemplate, Shell: HelpExampleShellNeutral},
	{ID: "template.everything-headless", Command: "catclip TARGET --include '*' --with-binaries --paths --headless", Kind: HelpExampleTemplate, Shell: HelpExampleShellNeutral},
	{ID: "template.include-target", Command: "catclip TARGET --include TARGET", Kind: HelpExampleTemplate, Shell: HelpExampleShellNeutral},
	...
	{ID: "template.preview", Command: "catclip TARGET --preview", Kind: HelpExampleTemplate, Shell: HelpExampleShellNeutral},
	...
	{ID: "include.dist-target", Command: "catclip dist --include dist", Kind: HelpExampleDeterministic, Shell: HelpExampleShellNeutral},
	{ID: "include.dist-paths", Command: "catclip dist --include dist --paths", Kind: HelpExampleDeterministic, Shell: HelpExampleShellNeutral},
	{ID: "include.dist-assets-target", Command: "catclip dist/assets --include dist", Kind: HelpExampleDeterministic, Shell: HelpExampleShellNeutral},
	{ID: "include.dist-assets-paths", Command: "catclip dist/assets --include dist --paths", Kind: HelpExampleDeterministic, Shell: HelpExampleShellNeutral},
	...
	{ID: "include.outside-target", Command: "catclip internal --include dist", Kind: HelpExampleExpectedError, Shell: HelpExampleShellNeutral},
	...
	{ID: "include.all-src-paths", Command: "catclip src --include '*' --paths", Kind: HelpExampleDeterministic, Shell: HelpExampleShellNeutral},
	...
	{ID: "include.cross-scope-node-modules", Command: "catclip src --then node_modules/react --include node_modules --paths", Kind: HelpExampleDeterministic, Shell: HelpExampleShellNeutral},
